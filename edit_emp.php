<div id="edit_emp<?php echo $emp_id; ?>" class="modal fade edit_user" role="dialog">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-3">
                                                                                    <div class="form-group">
                                                                                        <input type="text" class="form-control" id="edit_empid<?= $emp_id ?>" placeholder="รหัสพนักงาน" disabled value="<?php echo $emp_id ?>" name="userID">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-5">
                                                                                    <div class="form-group">
                                                                                        <input type="text" class="form-control check-type-name" id="emp_number<?= $emp_id ?>" placeholder="กรุณากรอกข้อมูล" name="empczid" required value="<?php echo $emp_czid; ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-5">
                                                                                    <div class="form-group">
                                                                                        <input type="date" class="form-control check-type-name" id="emp_hbd<?= $emp_id ?>" placeholder="กรุณากรอกข้อมูล" name="hbd" required value="<?php echo $emp_bd; ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-4">
                                                                                    <div class="form-group">
                                                                                        <input type="text" class="form-control check-type-name" id="emp_number<?= $emp_id ?>" placeholder="กรุณากรอกข้อมูล" name="empnumber" required value="<?php echo $emp_number; ?>">
                                                                                ...
                                                                                <div class="col-4">
                                                                                    <div class="form-group">
                                                                                        <input type="text" class="form-control check-type-name" id="emp_email<?= $emp_id ?>" placeholder="กรุณากรอกข้อมูล" name="empemail" required value="<?php echo $emp_email; ?>">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <div class="form-group" align="right">
                                                                                    <button type="button" class="btn btn-outline-primary" data-id='<?= $emp_id ?>' id="btn_update_emp">บันทึก</button>
                                                                                </div>
                                                                                <div class="form-group">

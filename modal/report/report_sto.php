            ...
            <div class="modal-content" style="width: auto;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="form-group">
                                <input type="date" class="form-control" id="date_in_pro1" name="date_in_pro1" readonly placeholder="กรอกข้อมูลที่ต้องการค้นหา">
                            </div>
                        </div>
                        ...
                        <div class="col-7">
                            <div class="form-group">
                                <input type="date" class="form-control" id="date_in_pro2" name="date_in_pro2" readonly placeholder="กรอกข้อมูลที่ต้องการค้นหา">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="dropdown">
                                <div class="form-group">
                                    <select class="form-control sel_type" id="month_year_in_pro" name="month_year_in_pro" readonly>
                                        <option selected value="0">----โปรดเลือก----</option>
                                        <?php
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group" align="right">
                                <button type="button" class="btn btn-outline-primary" name="btn_print_in_pro" id="btn_print_in_pro">พิมพ์</button>
                            </div>
                        </div>
